...
namespace LKaptchaNET.Extensions
{
    using LKaptchaNET.Options;
    using LKaptchaNET.Services.CaptchaGenerator;
    using LKaptchaNET.Services.Effect;
    using LKaptchaNET.Services.FontGenerator;
    using LKaptchaNET.Services.KeyGenerator;
    using LKaptchaNET.Services.Storage;
    using LKaptchaNET.Services.Validation;
